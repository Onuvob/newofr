...
<div class="container mt-3">
        ...
        <div id="showAppDetails" class="card-body">
            ...
            <div>
                ...
                <table class="table table-bordered table-sm table-striped">
                    ...
                    <tr>
                        <th class="table-header-color">Book Chapter Type :</th>
                        <td>{{ $bookchapter->chapter_type }}</td>
                    </tr>

                    <tr>
                        <th class="table-header-color">Applying for :</th>
                        <td class="header-shape">{{ $bookchapter->applying_for }}</td>
                    </tr>

                    <tr>
                        <th class="table-header-color">Application Status :</th>
                        <td>{{ $bookchapter->pub_status }}</td>
                    </tr>

                    <tr>
                        <th class="table-header-color">Book Chapter Article Title :</th>
                        <td>{{ $bookchapter->article_title }}</td>
                    </tr>

                    <tr>
                        <th class="table-header-color">Book Chapter Title :</th>
                        <td>{{ $bookchapter->book_title }}</td>
                    </tr>

                    <tr>
                        <th class="table-header-color">List of Authors :</th>
                        <td>{{ $bookchapter->list_of_authors }}</td>
                    </tr>

                    <tr>
                        <th class="table-header-color">Authors Affiliation :</th>
                        <td>{{ $bookchapter->authors_affiliation }}</td>
                    </tr>
            ...
            <div>
                ...
                <table class="table table-bordered table-sm table-striped">
                    <tr>
                        ...
                        <td>{{ $bookchapter->prefix }} {{ $bookchapter->first_name }} {{ $bookchapter->last_name }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $bookchapter->department }}</td>
                    </tr>

                    <tr>
                        <th class="table-header-color">Email :</th>
                        <td>{{ $bookchapter->email}}</td>
                    </tr>
            ...
            <div>
                ...
                <table class="table table-bordered table-sm table-striped">
                    <tr>
                        ...
                        <td><a href="{{ asset('storage/bookchapter/'. $bookchapter->file_name) }}">Open the file!</a></td>
                    </tr>
                </table>
    ...
    @if( $bookchapter->pub_status == 'Pending' and Auth::user()->is_admin)
    ...
    <div class="card-deck mt-5 text-center">
        ...
        <div class="card shadow-lg bg-transparent">
            ...
            <div class="card-body">
                ...
                <input id="get-cash-rewards" class="text-center" type="number" name="cashReward" value="{{ $bookchapter->cash_rewards }}" {{ ($bookchapter->pub_status == 'Accepted')? 'readonly="readonly"' : '' }} {{ (Auth::user()->is_admin)? '' : 'readonly="readonly"' }} {{ ($bookchapter->pub_status == 'Rejected')? 'readonly="readonly"' : '' }}>
        ...
        <div class="card shadow-lg bg-transparent">
            ...
            <div class="card-body">
                ...
                <input id="get-reward-points" class="text-center" type="number" name="rewardPoint" value="{{ $bookchapter->reward_points }}" {{ ($bookchapter->pub_status == 'Accepted')? 'readonly="readonly"' : '' }} {{ (Auth::user()->is_admin)? '' : 'readonly="readonly"' }} {{ ($bookchapter->pub_status == 'Rejected')? 'readonly="readonly"' : '' }}>
        ...
        <div class="card shadow-lg bg-transparent">
            ...
            <div class="card-body">
                ...
                <textarea id="get-remarks" class="text-center" type="text" value="{{ $bookchapter->remarks }}" {{ ($bookchapter->pub_status == 'Accepted')? 'readonly="readonly"' : '' }} {{ (Auth::user()->is_admin)? '' : 'readonly="readonly"' }} {{ ($bookchapter->pub_status == 'Rejected')? 'readonly="readonly"' : '' }}>{{ $bookchapter->remarks }}</textarea>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ url('user/' . $bookchapter->email) }}">
                    ...
                    <div id="" class="">
                        ...
                        <input style="display: none;" name="bookchapter_ID" type="number" class="form-control" readonly="readonly" value="{{ $bookchapter->id }}">

                        <input style="display: none;" name="numCoAuthors" type="number" class="form-control" readonly="readonly" value="{{ $bookchapter->list_of_authors }}">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ url('publication/bookchapters/' . $bookchapter->email) }}">
                    ...
                    <div id="" class="">
                        ...
                        <input style="display: none;" name="reject_bookchapter_ID" type="number" class="form-control" readonly="readonly" value="{{ $bookchapter->id }}">
