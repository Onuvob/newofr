...
@section('title', 'OFR | View Rejected Journals')

@section('content')

<div class="container">

    <h4 class="header-shape shadow animated fadeInLeft">Publication Claim Rejected Journals</h4>

    <div class="card text-center shadow animated fadeIn bg-transparent">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link active" href="/rejectedjournals">Journal</a>
                </li>
                <li class="nav-item">
                    ...
                    <tbody>
                        ...
                        @foreach($journals as $journal)
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="rejectedjournals/{{ $journal->id }}"><i class="fas fa-check-square"></i></a></td>
                            </tr>
